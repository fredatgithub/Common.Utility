...
namespace Common.Utility
{
  ...
  //iu.AddText = string.Empty;
  //iu.CopyIamgePath = string.Empty;
  //iu.DrawString_x = ;
  //iu.DrawString_y = ;
  //iu.DrawStyle = ;
  //iu.Font = string.Empty;
  //iu.FontSize = ;
  //iu.FormFile = File1;
  //iu.IsCreateImg =;
  //iu.IsDraw = ;
  //iu.OutFileName = string.Empty;
  //iu.OutThumbFileName = string.Empty;
  //iu.SavePath = @"~/image/";
  //iu.SaveType = ;
  //iu.sHeight  = ;
  //iu.sWidth   = ;
  ...
  public class ImageUpload
  {
    ...
    private string _InFileName = string.Empty;//非自动生成文件名设置。 
    private string _OutFileName = string.Empty;//输出文件名。 
    ...
    public void Upload()
    {
      ...
      try
      {
        ...
        if (_IsDraw)
        {
          if (_DrawStyle == 0)
          {
            System.Drawing.Image Img1 = Image.FromStream(newFile);
          ...
          {
            System.Drawing.Image image = Image.FromStream(newFile);
            System.Drawing.Image copyImage = Image.FromFile(_CopyIamgePath);
        ...
        //获取图片的高度和宽度
        System.Drawing.Image Img = Image.FromStream(newFile);
        _Width = Img.Width;
        _Height = Img.Height;
        ...
        if (_IsCreateImg)
        {
          ...
          System.Drawing.Image newImg = Img.GetThumbnailImage(_sWidth, _sHeight, null, IntPtr.Zero);
